<template>
  <div class="chess-arena-wrapper">
    ...
    <chess-online-race-panel :fightLevel="fightLevel" :fightLogo="fightLogo" :fightName="fightName"
      @start-fight="startGame" :is-match-success="isMatchSuccess" :wait-time="waitTime" @start-game="goGame"
      @hide="hideOnlineRacePanel" :is-show="showOnlineRacePanel"></chess-online-race-panel>
    <chess-check-point-panel :level="selectedLevel" :begin="beginNum" :end="endNum" :show-title="selectedTitle" @hide="hideCheckPointPanel" :is-show="showCheckPointPanel">
  ...
  export default {
    ...
    methods: {
      ...
      getMachineName() {
        ...
        sessionStorage.setItem('fightLogo', require('../assets/images/user-logo.png'));
      },
      goRequest() {},
            ...
            if (msg.data.indexOf("b login success") != -1) {
              ...
              if (!sessionStorage.getItem("user_type2")) {
                ...
                this.socket.send(
                  ...
                  type: "user",
                  content: "getuser"+JSON.stringify({
                    userId:this.userId
                  }),
                  user_type: sessionStorage.getItem("user_type")
                })}`
              ...
              switch (data.type) {
                case "user":
                  ...
                  if (
                    ...
                    //用户发送userID给对方
                    this.getPersonInfo(JSON.parse(data.content.substring(7)).userId);
...
<style scoped>
  .chess-arena-wrapper {
    ...
    height: 100%;
    height: 100%;
    background: url(../assets/images/arena-bg.png) no-repeat, url(../assets/images/mountain-light.png) no-repeat, url(../assets/images/mountain-dark.png) no-repeat, url(../assets/images/sky.png) no-repeat;
