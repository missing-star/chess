<template>
  <div class="chess-home">
    ...
    <!-- 背景音乐 -->
    <audio ref="audio" id="audio-music" loop preload="auto" muted src="../assets/audio/bg.mp3">
    </audio>
    <!-- 用户信息 -->
    ...
    <button @click="changeBgM" class="change-bg" style="position:absolute;left:5rem;top:5rem;z-index:111;">换背景</button>
    <!-- 公告栏 -->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      changeBgM() {
        this.$refs.audio.src = '../assets/audio/我的棋社作业背景.mp3';
        this.$nextTick(() => {
