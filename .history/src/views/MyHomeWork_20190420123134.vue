...
import {initChess,onChose,map,recordList,isFinshed, tipsCount,showrecordList} from "../assets/js/my-homework/CChess";
    ...
    submitHomework() {
      this.$axios({
        ...
        data:this.qs.stringify({
          is_read:1,
          status:1,
          data_text:this.recordList,
          play_log:this.showrecordList,
          tip_num:this.tipsCount,
          post_at:''
        })
      })
    },
