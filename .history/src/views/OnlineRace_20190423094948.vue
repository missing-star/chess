    ...
    <div class="chess-online-race-wrapper">
        ...
        <div class="right-part-wrapper">
            <div class="black-wrapper">
                ...
                <div class="current-percent-wrapper">
                    <div class="progressbar-wrapper">
                        <div class="progressbar" :style="{width:(totalTimesBlack.value / 1200)*100+'%'}"></div>
                    </div>
                    <p class="percent">{{parseFloat(totalTimesBlack.value / 1200).toFixed(2)*100}}%</p>
                </div>
            ...
            <div class="red-wrapper">
                ...
                <div class="current-percent-wrapper">
                    <div class="progressbar-wrapper">
                        <div class="progressbar" :style="{width:(totalTimesRed.value / 1200)*100+'%'}"></div>
                    </div>
                    <p class="percent">{{parseFloat(totalTimesRed.value / 1200).toFixed(2)*100}}%</p>
                </div>
                <div class="current-time-info-wrapper">
