<template>
  <div class="chess-login-wrapper">
    ...
    <div class="elephant-wrapper">
      <img src="/images/home-icon.png" class="qi-icon">
      <img src="/images/elephant.png" class="elephant-icon">
    </div>
...
div.register-top {
  height: 22%;
  background: url(/images/house-top.png) no-repeat;
  background-size: 100% 100%;
  z-index: 3;
  position: relative;
}
div.register-body {
  background: url(/images/house-body.png) no-repeat;
...
div.register-login-wrapper {
  position: absolute;
  width: 60%;
  background: url(/images/register-yellow-1.png) no-repeat;
...
div.register-register-wrapper {
  position: absolute;
  width: 90%;
  background: url(/images/register-yellow-2.png) no-repeat;
  background-size: 100% 100%;
  height: 95%;
  top: 3%;
  left: 3%;
...
div.content.find-pwd {
  background: url(/images/register-yellow-3.png) no-repeat;
  background-size: 100% 100%;
  height: 95%;
  width: 95%;
  top: 2%;
