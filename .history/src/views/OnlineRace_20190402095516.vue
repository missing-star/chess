        ...
        <div class="right-part-wrapper">
            ...
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn">
                    <img src="../assets/images/悔棋.png" alt="悔棋" class="operation-item">
                    <img src="../assets/images/和棋.png" alt="和棋" class="operation-item">
                    <img src="../assets/images/认输.png" alt="认输" class="operation-item">
                </div>
            </div>
