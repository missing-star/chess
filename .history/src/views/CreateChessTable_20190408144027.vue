            ...
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn">
                    <div class="operation-item pointer">
                        <img src="../assets/images/摆满棋子.png" alt="摆满棋子">
                        <img src="../assets/images/摆满棋子-选中.png" alt="摆满棋子-active">
                    </div>
                    <div class="operation-item pointer">
                        <img src="../assets/images/前进.png" alt="摆满棋子">
                        <img src="../assets/images/前进-选中.png" alt="摆满棋子-active">
                    </div>
                    <div class="operation-item pointer">
                        <img src="../assets/images/后退.png" alt="摆满棋子">
                        <img src="../assets/images/后退-选中.png" alt="摆满棋子-active">
                    </div>
                    <div class="operation-item pointer">
                        <img src="../assets/images/翻转.png" alt="摆满棋子">
                        <img src="../assets/images/翻转-选中.png" alt="摆满棋子-active">
                    </div>
                    <div class="operation-item pointer">
                        <img src="../assets/images/重置.png" alt="摆满棋子">
                        <img src="../assets/images/重置-选中.png" alt="摆满棋子-active">
                    </div>
                    <div class="operation-item pointer">
                        <img src="../assets/images/确定.png" alt="摆满棋子">
                        <img src="../assets/images/确定-选中.png" alt="摆满棋子-active">
                    </div>
                    <div class="operation-item pointer">
                        <img src="../assets/images/保存.png" alt="摆满棋子">
                        <img src="../assets/images/保存-选中.png" alt="摆满棋子-active">
                    </div>
                </div>
            </div>
        </div>
