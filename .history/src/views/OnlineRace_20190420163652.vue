...
import {initChess,onChose,isOnline,searchEngine,backOperation,quitGame,move} from '../assets/js/online/CChess'
...
export default {
    ...
    mounted() {
        setInterval(() => {
            ...
            let second = newDate.getSeconds() < 10 ? '0' + newDate.get
            this.showGameTime = (newDate.getHours()-8) + ':'+newDate.getMinutes() + ':' +newDate.getSeconds();
        }, 1000);
    }
}
</script>
