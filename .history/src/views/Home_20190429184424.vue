<template>
  <div class="chess-home">
    ...
    <div class="cloud-wrapper">
      <img v-for="(img,index) in cloudList" :src="img" :key="index" :style="{top:index*getRandom()+'px';left:index*getRandom()+'px'}" class="cloud-icon">
    </div>
    <!-- 背景音乐 -->
...
img.cloud-icon {
    width: 10%;
    position: absolute;
    /* animation: move 30s linear 0.5s infinite; */
}
@keyframes move {
  from {
    left:-200px;
