<template>
  <div class="chess-home">
    ...
    <div class="notice-container" @click="openNoticePanel">
      <img src="images/bulletin-board.png" alt="公告栏">
    </div>
    <chess-notice-panel
    ...
    <!-- 小象 -->
    <img @click="openPetPanel" src="images/elephant.png" class="elephant">
    <!-- 我的宠物 -->
    <chess-pet-panel
    ...
    <div class="mailbox-wrapper">
      <img src="images/mailbox.png" @click="openMailPanel">
      ...
      roomList: [
        {
          ...
          name: "棋社",
          icon: require("images/chess-room.png")
        },
        {
          url: "/arena",
          name: "竞技场",
          icon: require("images/arena.png")
        },
        {
          url: "/star-room",
          name: "将星阁",
          icon: require("images/jiangxingge.png"),
          logo: require("images/teacher.png")
        },
        {
          url: "openSelfStudyPanel",
          name: "自习室",
          icon: require("images/study-room.png")
        }
      ],
      ...
      this.$axios({
        ...
        .then(res => {
          if (res.status == 1) {
            this.show1 = true;
            if (index == 0) {
              this.avter = require("images/喂食成功.png");
              this.btnImg = require("images/喂养icon.png");
            } else if (index == 1) {
              this.avter = require("images/对话成功.png");
              this.btnImg = require("images/对话icon.png");
            } else if (index == 2) {
              this.avter = require("images/调教成功.png");
              this.btnImg = require("images/调教icon.png");
            } else if (index == 3) {
              this.avter = require("images/嬉戏成功.png");
              this.btnImg = require("images/嬉戏icon.png");
            }
            ...
            this.show1 = true;
            if (index == 0) {
              this.avter = require("images/明天1.png");
              this.btnImg = require("images/喂养icon.png");
            } else if (index == 1) {
              this.avter = require("images/明天2.png");
              this.btnImg = require("images/对话icon.png");
            } else if (index == 2) {
              this.avter = require("images/明天3.png");
              this.btnImg = require("images/调教icon.png");
            } else if (index == 3) {
              this.avter = require("images/明天4.png");
              this.btnImg = require("images/嬉戏icon.png");
            }
            this.showCreateSucess = true;
            this.isClose();
