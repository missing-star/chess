<template>
    <div class="content">
			...
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
				...
				consequat.</p>
			<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Quis
...
import {factory} from 'malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min';
export default {
    created() {
        this.$nextTick(() => {
			console.log(factory);
