        ...
        <div class="right-part-wrapper">
            ...
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn">
                    <img @click="backOperation" src="./images/悔棋.png" alt="悔棋" class="operation-item pointer">
                    <img src="./images/和棋.png" alt="和棋" class="operation-item pointer">
                    <img @click="quitGame" src="./images/认输.png" alt="认输" class="operation-item pointer">
                </div>
            </div>
...
<style scoped>
    ...
    .black-wrapper,.red-wrapper {
        width: 100%;
        background: url(./images/棋手信息底.png) no-repeat;
        background-size: 100% 100%;
        height: 15rem;
    }
    ...
    div.user-logo-wrapper.red{
        background: url(./images/红方头像.png) no-repeat;
        background-size: 100% 100%;
        width: 7vh;
        height: 7vh;
        display: flex;
