        ...
        <div class="middle-part-wrapper">
            <div class="black-chess-wrapper">
                <span class="chess-item">
                    <img @click="chooseQi('black','ju',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.black.ju.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','ma',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.black.ma.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','xiang',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.black.xiang.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','shi',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.black.shi.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','pao',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.black.pao.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','zu',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.black.zu.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','shuai',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.black.shuai.counts}}</i>
                </span>
            </div>
            ...
            <div class="red-chess-wrapper">
                <span class="chess-item">
                    <img @click="chooseQi('red','ju',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.red.ju.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','ma',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.red.ma.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','pao',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.red.pao.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','shi',$event)" src="img/che2-c.png" alt="">
                ...
                <span class="chess-item">
                    <img @click="chooseQi('red','zu',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.red.zu.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','jiang',$event)" src="img/che2-c.png" alt="">
                    <i class="icon-number">{{numberList.red.jiang.counts}}</i>
                </span>
            </div>
        </div>
...
import {initChess,onChose,resetPanel,backRecord,nextRecord,recordList,showrecordList,currentIndex,map} from '../assets/js/create/CChess'
...
export default {
    ...
    methods:{
        ...
        chooseQi(type, key, event) {
            if (type == 'black') {
                $('.Checkerboard_bot span').removeClass('active');
            } else {
                $('.Checkerboard_top span').removeClass('active');
            }
            if (this.numberList[type][key].counts > 0) {
                ...
                this.selectedQi = this.numberList[type][key].value;
            }
        },
        addActive(target) {
