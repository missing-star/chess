    ...
    <div class="chess-private-school-wrapper">
        ...
        <div class="category-wrapper">
            <div class="category-item">
                <button class="start-game pointer" @click="manageStudent">棋谱</button>
            </div>
        </div>
        <!-- 学生管理 -->
        <chess-manage-student-panel :is-show="showManageStudentPanel" @hide="hideManageStudentPanel"></chess-manage-student-panel>
        <!-- 师徒管理 -->
        <chess-manage-apprentice-panel :is-show="showManageApprenticePanel" @hide="hideManageApprenticePanel"></chess-manage-apprentice-panel>
