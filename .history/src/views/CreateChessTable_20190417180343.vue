        ...
        <div class="middle-part-wrapper">
            <div class="black-chess-wrapper">
                <span class="chess-item">
                    <img @click="chooseQi('black','ju',$event)" src="../../public/images/che2.png" alt="">
                    <i class="icon-number">{{numberList.black.ju.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','ma',$event)" src="../../public/images/ma2.png" alt="">
                    <i class="icon-number">{{numberList.black.ma.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','xiang',$event)" src="../../public/images/xiang2.png" alt="">
                    <i class="icon-number">{{numberList.black.xiang.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','shi',$event)" src="../../public/images/shi2.png" alt="">
                    <i class="icon-number">{{numberList.black.shi.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','pao',$event)" src="../../public/images/pao2.png" alt="">
                    <i class="icon-number">{{numberList.black.pao.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','zu',$event)" src="../../public/images/zu.png" alt="">
                    <i class="icon-number">{{numberList.black.zu.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('black','jiang',$event)" src="../../public/images/jiang.png" alt="">
            ...
            <div class="red-chess-wrapper">
                <span class="chess-item">
                    <img @click="chooseQi('red','ju',$event)" src="../../public/images/che1.png" alt="">
                    <i class="icon-number">{{numberList.red.ju.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','ma',$event)" src="../../public/images/ma1.png" alt="">
                    <i class="icon-number">{{numberList.red.ma.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','xiang',$event)" src="../../public/images/xiang1.png" alt="">
                    <i class="icon-number">{{numberList.red.xiang.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','shi',$event)" src="../../public/images/shi1.png" alt="">
                    <i class="icon-number">{{numberList.red.shi.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','pao',$event)" src="../../public/images/pao1.png" alt="">
                    <i class="icon-number">{{numberList.red.pao.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','zu',$event)" src="../../public/images/bing.png" alt="">
                    <i class="icon-number">{{numberList.red.zu.counts}}</i>
                </span>
                <span class="chess-item">
                    <img @click="chooseQi('red','shuai',$event)" src="../../public/images/shuai.png" alt="">
            ...
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn">
                    <div class="operation-item pointer">
                        <img @click="fillUp" src="../../public/images/摆满棋子.png" alt="摆满棋子" class="operation-item-icon not-active">
                        <img src="../../public/images/摆满棋子-选中.png" alt="摆满棋子-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="forward" src="../../public/images/前进.png" alt="前进" class="operation-item-icon not-active">
                        <img src="../../public/images/前进-选中.png" alt="前进-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="backOff" src="../../public/images/后退.png" alt="后退" class="operation-item-icon not-active">
                        <img src="../../public/images/后退-选中.png" alt="后退-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="flip" src="../../public/images/翻转.png" alt="翻转" class="operation-item-icon not-active">
                        <img src="../../public/images/翻转-选中.png" alt="翻转-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="reset" src="../../public/images/重置.png" alt="重置" class="operation-item-icon not-active">
                        <img src="../../public/images/重置-选中.png" alt="重置-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="saveChessMap" src="../../public/images/确定.png" alt="确定" class="operation-item-icon not-active">
                        <img src="../../public/images/确定-选中.png" alt="确定-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="save" src="../../public/images/保存.png" alt="保存" class="operation-item-icon not-active">
                        <img src="../../public/images/保存-选中.png" alt="保存-active" class="operation-item-icon active">
                    </div>
...
<style scoped>
    ...
    div.left-part-wrapper,div.right-part-wrapper{
        background: url(../../public/images/信息显示底.png) no-repeat;
    ...
    div.middle-part-wrapper{
        background: url(../../public/images/棋盘底.png) no-repeat;
        background-size: 100% 100%;
        width: 100vh;
        height: 100vh;
        min-height: 900px;
    ...
    div.chess-panel{
        width: 81%;
        height: 90%;
        background: url(../../public/images/棋盘.png) no-repeat;
    ...
    div.user-logo-wrapper{
        background: url(../../public/images/黑方头像底.png) no-repeat;
        background-size: 100% 100%;
        width: 7vh;
        height: 7vh;
        display: flex;
    ...
    div.race-operation-wrapper{
        background: url(../../public/images/操作台底.png) no-repeat;
        background-size: 100% 100%;
        height: 22rem;
    }
    .right-part-wrapper {
    ...
    span.chess-item.active {
        background: url(../../public/images/select-chess.png) no-repeat;
        background-size: 100% 100%;
    }
</style>
