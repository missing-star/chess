<template>
  <div class="chess-login-wrapper">
    ...
    <div class="elephant-wrapper">
      <img src="../../public/images/home-icon.png" class="qi-icon">
      <img src="../../public/images/elephant.png" class="elephant-icon">
    </div>
          ...
          <div class="register-register-wrapper">
            <div class="content" v-if="currentPanel == 0">
              ...
              <chess-select
                ...
                styles="position:absolute;right:2.2rem;top:5.2rem;z-index:3;"
              ></chess-select>
              <chess-input
                v-model="username"
                styles="width:95%"
              ...
              <div class="btn-group">
                <button @click="login" class="enter-game">进入游戏</button>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    selectRole(role) {
      ...
      this.role =
        role == 0 ? { text: "老师", value: 0 } : { text: "学生", value: 1 };
      if (role != 0) {
...
div.register-top {
  height: 22%;
  background: url(../../public/images/house-top.png) no-repeat;
  background-size: 100% 100%;
  z-index: 3;
  position: relative;
}
div.register-body {
  background: url(../../public/images/house-body.png) no-repeat;
...
div.register-login-wrapper {
  position: absolute;
  width: 60%;
  background: url(../../public/images/register-yellow-1.png) no-repeat;
...
div.register-register-wrapper {
  position: absolute;
  width: 90%;
  background: url(../../public/images/register-yellow-2.png) no-repeat;
  background-size: 100% 100%;
  height: 95%;
  top: 3%;
  left: 3%;
...
div.content.find-pwd {
  background: url(../../public/images/register-yellow-3.png) no-repeat;
  background-size: 100% 100%;
  height: 95%;
  width: 95%;
  top: 2%;
