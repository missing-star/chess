...
export default {
  data() {
    return {
      ...
      workList1: [], //我的作业
      workList2: [], //我的作业
      gameList1: {list:{child:{}}}, //自习室分类
      gameList2: {list:{child:{}}}, //自习室分类
      gameList3: {list:{child:{}}}, //自习室分类
      day_job: "",
      pass_log: "",
      number: ""
    };
    ...
    openSelfStudyPanel() {
      ...
      this.$axios({
        ...
        .then(res => {
          ...
          this.gameList3 = res.data.data[ids[2]];
          this.gameList3.id = ids[2];
          console.log('this.gamelist1='+this.gameList1);
        })
        .catch(error => {
          console.log(error);
        });
