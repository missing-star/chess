...
import {initChess,onChose,isOnline,searchEngine,backOperation,quitGame,move,waitTimes,fightTimes} from '../assets/js/online/CChess'
...
export default {
        ...
        redTime(){
            if(sessionStorage.getItem('isRed') == 'true') {
                ...
                if(this.fightTimes.value == 60) {
                    ...
                    return '00:'+(this.fightTimes.value < 10 ? ''+this.fightTimes.value : this.fightTimes.value);
                }
            }
        },
        blackTime(){
            if(sessionStorage.getItem('isRed') == 'true') {
                if(this.fightTimes.value == 60) {
                    ...
                    return '00:'+this.fightTimes.value;
                }
            }
            else {
                if(waitTimes.value == 60) {
                    ...
                    return '00:'+this.waitTimes.value;
                }
            }
        }
    },
    mounted() {
        ...
        setInterval(() => {
            ...
            this.showGameTime = hour +':'+ minute + ':' + second;
        }, 1000);
    },
    methods:{
