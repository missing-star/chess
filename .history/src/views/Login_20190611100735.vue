          ...
          <div class="register-register-wrapper">
            <div class="content" v-if="currentPanel == 0">
              ...
              <chess-select
                ...
                @select="selectSex"
                :is-show="showSelect"
                styles="position:absolute;right:12%;top:28%;z-index:1;"
              ></chess-select>
            ...
            <div class="content" v-if="currentPanel == 1">
              ...
              <chess-select
                ...
                styles="position:absolute;right:12%;top:22%;z-index:1"
              ></chess-select>
              <chess-input
                styles="width:95%"
                label="姓名"
  ...
  methods: {
    ...
    register() {
      if (
        ...
        this.$axios({
          method: "post",
          url: `${"http://process.env.VUE_APP_URL.cn"}/index.php?r=api-student/student-register`,
          data: this.qs.stringify({
    ...
    forget() {
      if (
        ...
        if ((this.Fpassword = this.Fpassword1)) {
          this.$axios({
            method: "post",
            url: `${"http://process.env.VUE_APP_URL.cn"}/index.php?r=api-student/update-pass`,
            data: this.qs.stringify({
              crad: this.Fcrad,
              code: this.Fcode,
