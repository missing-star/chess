...
quitGame,move,waitTimes,fightTimes,showGameTime,countRaceTime,api,recordList,showRecordList,Back,noWinner,countTimes,countTimes2} from '../assets/js/online/CChess'
