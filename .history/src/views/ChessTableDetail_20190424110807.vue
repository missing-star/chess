        ...
        <div class="right-part-wrapper">
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn content">
                    <textarea v-model="comments" readonly>打发打df打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发打发打dffdask发fdask发</textarea>
                </div>
            </div>
            <div class="race-operation-wrapper">
                <p class="title operation">
