        ...
        <div class="right-part-wrapper">
            ...
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn">
                    <img @click="backOperation" src="../../public/images/悔棋.png" alt="悔棋" class="operation-item pointer">
                    <img src="../../public/images/和棋.png" alt="和棋" class="operation-item pointer">
                    <img @click="quitGame" src="../../public/images/认输.png" alt="认输" class="operation-item pointer">
                </div>
            </div>
...
import {initChess,onChose,isOnline,searchEngine,backOperation,quitGame} from '../assets/js/online/CChess'
...
<style scoped>
    ...
    .black-wrapper,.red-wrapper {
        width: 100%;
        background: url(../../public/images/棋手信息底.png) no-repeat;
        background-size: 100% 100%;
        height: 15rem;
    }
    ...
    div.user-logo-wrapper.red{
        background: url(../../public/images/红方头像.png) no-repeat;
        background-size: 100% 100%;
        width: 7vh;
        height: 7vh;
        display: flex;
