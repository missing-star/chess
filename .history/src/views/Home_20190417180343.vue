<template>
  <div class="chess-home">
    ...
    <div class="user-info-wrapper-container">
      <div class="user-info-wrapper">
        <div class="user-logo-wrapper">
          <img src="../../public/images/user-logo.png" class="user-logo">
        </div>
    ...
    <div class="notice-container" @click="openNoticePanel">
      <img src="../../public/images/bulletin-board.png" alt="公告栏">
    </div>
    <chess-notice-panel
    ...
    <!-- 小象 -->
    <img @click="openPetPanel" src="../../public/images/elephant.png" class="elephant">
    <!-- 我的宠物 -->
    <chess-pet-panel
    ...
    <div class="mailbox-wrapper">
      <img src="../../public/images/mailbox.png" @click="openMailPanel">
      ...
      roomList: [
        {
          ...
          name: "棋社",
          icon: require("../../public/images/chess-room.png")
        },
        {
          url: "/arena",
          name: "竞技场",
          icon: require("../../public/images/arena.png")
        },
        {
          url: "/star-room",
          name: "将星阁",
          icon: require("../../public/images/jiangxingge.png"),
          logo: require("../../public/images/teacher.png")
        },
        {
          url: "openSelfStudyPanel",
          name: "自习室",
          icon: require("../../public/images/study-room.png")
        }
      ],
      ...
      this.$axios({
        ...
        .then(res => {
          if (res.status == 1) {
            this.show1 = true;
            if (index == 0) {
              this.avter = require("../../public/images/喂食成功.png");
              this.btnImg = require("../../public/images/喂养icon.png");
            } else if (index == 1) {
              this.avter = require("../../public/images/对话成功.png");
              this.btnImg = require("../../public/images/对话icon.png");
            } else if (index == 2) {
              this.avter = require("../../public/images/调教成功.png");
              this.btnImg = require("../../public/images/调教icon.png");
            } else if (index == 3) {
              this.avter = require("../../public/images/嬉戏成功.png");
              this.btnImg = require("../../public/images/嬉戏icon.png");
            }
            ...
            this.show1 = true;
            if (index == 0) {
              this.avter = require("../../public/images/明天1.png");
              this.btnImg = require("../../public/images/喂养icon.png");
            } else if (index == 1) {
              this.avter = require("../../public/images/明天2.png");
              this.btnImg = require("../../public/images/对话icon.png");
            } else if (index == 2) {
              this.avter = require("../../public/images/明天3.png");
              this.btnImg = require("../../public/images/调教icon.png");
            } else if (index == 3) {
              this.avter = require("../../public/images/明天4.png");
              this.btnImg = require("../../public/images/嬉戏icon.png");
            }
            this.showCreateSucess = true;
            this.isClose();
