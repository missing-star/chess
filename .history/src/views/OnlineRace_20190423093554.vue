        ...
        <div class="right-part-wrapper">
            <div class="black-wrapper">
                ...
                <div class="current-percent-wrapper">
                    <div class="progressbar-wrapper">
                        <div class="progressbar" :style="{width:(totalTimesRed / 20)*100+'%'}"></div>
                    </div>
                    <p class="percent">{{parseFloat(totalTimesBlack / 20).toFixed(2)}}%</p>
                </div>
                <div class="current-time-info-wrapper">
                    局时：{{surplusTimeBlack}} 步时：{{blackTime}}
                </div>
            </div>
            ...
            <div class="red-wrapper">
                ...
                <div class="current-percent-wrapper">
                    ...
                    <p class="percent">{{parseFloat(totalTimesRed / 20).toFixed(2)}}%</p>
                </div>
                <div class="current-time-info-wrapper">
                    局时：{{surplusTimeRed}} 步时：{{redTime}}
                </div>
            </div>
        </div>
...
quitGame,move,waitTimes,fightTimes,api,recordList,showRecordList,Back,noWinner,countTimes,countTimes2,
totalTimesBlack,totalTimesRed} from '../assets/js/online/CChess'
...
export default {
    ...
    watch:{
        totalTimesRed:{//深度监听，可监听到对象、数组的变化
            handler(val, oldVal){
                console.log("b.c: "+val.value, oldVal.value);//但是这两个值打印出来却都是一样的
            },
            deep:true
        }
    },
