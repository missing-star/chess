...
export default {
  ...
  methods:{
    ...
    submitHomework() {
      console.log(this.recordList.slice(0,this.currentIndex.value))
      if (currentIndex.value % 2 == 0) {
          this.showrecordList.splice(parseInt(currentIndex.value / 2));
      } else {
          this.showrecordList.splice(parseInt(currentIndex.value / 2) + 1);
          this.showrecordList[parseInt(currentIndex.value / 2)].black = '';
          record = showrecordList[parseInt(currentIndex.value / 2)];
      }
      // this.$axios({
