...
div.chess-star-wrapper {
  ...
  width: 100%;
  height: 100%;
  background: url(../../public/images/将星阁banner.jpg) no-repeat;
...
div.inform_left {
  width: 45%;
  height: 73%;
  background: url(../../public/images/picture.png) no-repeat;
  background-size: 100% 100%;
  margin-right: 7%;
  padding: 4% 3%;
}
...
div.inform_right_introduce {
  width: 100%;
  height: 66%;
  background: url(../../public/images/information.png) no-repeat;
  background-size: 100% 100%;
  padding: 10% 7%;
}
...
div.obeying_master {
  width: 10%;
  height: 10%;
  background: url(../../public/images/拜师.png) no-repeat;
  background-size: 100% 100%;
  position: absolute;
  top: 61%;
  left: 45%;
...
.teacher-item{
  background: url(../../public/images/teacher-bg.png) no-repeat;
  background-size: 100% 100%;
  height: 90%;
  width: calc(100% / 8);
  display: flex;
...
.teacher-item.active{
  background: url(../../public/images/teacher-bg-active.png) no-repeat;
  background-size: 100% 100%;
  height: 90%;
  width: calc(100% / 8);
  display: flex;
