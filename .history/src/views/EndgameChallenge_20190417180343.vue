    ...
    <div class="chess-my-homework-wrapper">
        <div class="left-part-wrapper">
            <div class="content-wrapper">
                ...
                <img @click="getCheckPointDetail" src="../../public/images/重做.png" class="redo-icon pointer">
            </div>
        </div>
...
import {initChess,onChose,map,recordList} from '../assets/js/check-point/CChess'
