...
import {initChess,onChose,map,recordList,isFinshed, tipsCount,showrecordList, showrecordListStu} from "../assets/js/my-homework/CChess";
...
export default {
  ...
  data() {
    return {
      ...
      showRecordListStu:showrecordListStu
    };
  },
  methods:{
    //获得棋谱详情
