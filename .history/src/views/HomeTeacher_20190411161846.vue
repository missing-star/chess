<template>
    <div class="chess-home">
        ...
        <chess-notice-panel @hide="hideNoticePanel" :isShow="showNoticePanel" @open-notice-detail="openNoticeDetailPanel"></chess-notice-panel>
        <!-- 设置弹框 -->
        ...
        <!-- 老师个人信息 -->
        <chess-personal-info-panel :teacher-info="teacherInfo" @hide="hidePersonalInfoPanel" :isShow="showPersonalInfoPanel"></chess-personal-info-panel>
        <!-- 管理收徒 -->
        ...
        <!-- 公告详情 -->
        <chess-notice-detail-panel :notice-detail="noticeDetail" @hide="hideNoticeDetailPanel" :isShow="showNoticeDetailPanel"></chess-notice-detail-panel>
        <!-- 信息提示框 -->
