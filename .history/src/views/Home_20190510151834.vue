<template>
  <div class="chess-home">
    ...
    <!-- 每日任务 -->
    <div class="daily-task-wrapper" :class="{active:isOpenTask}" @click="toggleTask">
      <div class="daily-task" :class="{active:isOpenTask}">
...
<style scoped>
  ...
  div.daily-task-wrapper {
    background: rgba(184, 245, 252, 0.5);
    background-size: 100% 100%;
    width: 10vw;
    height: 2.5vw;
    position: absolute;
  ...
  div.daily-task-wrapper.active {
    background: url(../assets/images/daily-task-active-bg.png) no-repeat;
    background-size: 100% 100%;
    width: 10vw;
    height: 10vw;
    position: absolute;
