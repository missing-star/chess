        ...
        <div class="right-part-wrapper">
            ...
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn">
                    ...
                    <button @click="printList">打印数据</button>
                </div>
            </div>
...
quitGame,move,waitTimes,fightTimes,showGameTime,countRaceTime,api,recordList,showrecordList} from '../assets/js/online/CChess'
