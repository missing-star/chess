    ...
    <div class="chess-online-race-wrapper">
        ...
        <div class="middle-part-wrapper">
            ...
            <div class="red-chess-wrapper">
                ...
                <span class="chess-item">
                    <img @click="chooseQi('red','pao',$event)" src="../assets/images/xiang1.png" alt="">
...
import {initChess,onChose,resetPanel,backRecord,nextRecord,recordList,showrecordList,currentIndex,map, numberList, selectedQi} from '../assets/js/create/CChess'
