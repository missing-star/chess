...
<style scoped>
  ...
  div.bird-container:nth-child(1) {
				animation: fly 4.24s 100ms linear infinite;
				top:0.2rem;
			}
			div.bird-container:nth-child(2) {
				animation: fly 4.24s 200ms linear infinite;
				top:0.4rem;
			}
			div.bird-container:nth-child(3) {
				animation: fly 4.24s linear infinite;
				top:0.6rem;
			}
			div.bird-container:nth-child(4) {
				animation: fly 4.24s 100ms linear infinite;
				top:0.8rem;
			}
			div.bird-container:nth-child(5) {
				animation: fly 4.24s 200ms linear infinite;
				top:1rem;
			}
			@keyframes fly{
