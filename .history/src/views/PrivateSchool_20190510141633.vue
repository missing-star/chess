<template>
  <div class="chess-private-school-wrapper">
    <div class="category-wrapper">
        <button class="operation-item student pointer" @click="manageStudent"></button>
        <button class="operation-item apprentice pointer" @click="manageMentor"></button>
    </div>
    <!-- 学生管理 -->
...
button.operation-item.student{
  background: url(../assets/images/学生管理.png) no-repeat;
    background-size: 100% 100%;
}
button.operation-item.student:active{
  background: url(../assets/images/学生管理-active.png) no-repeat;
    background-size: 100% 100%;
}
button.operation-item.apprentice{
  background: url(../assets/images/师徒管理.png) no-repeat;
    background-size: 100% 100%;
}
button.operation-item.apprentice:active{
  background: url(../assets/images/师徒管理-active.png) no-repeat;
    background-size: 100% 100%;
}
</style>
