...
quitGame,move,waitTimes,fightTimes,showGameTime,countRaceTime,api,recordList,showRecordList,Back,noWinner,countTimes,countTimes} from '../assets/js/online/CChess'
