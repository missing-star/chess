<template>
    <div class="chess-private-school-wrapper">
        ...
        <!-- 学生管理 -->
        <chess-manage-student-panel @open-create-grade="openCreateGradePanel" :is-show="showManageStudentPanel" @hide="hideManageStudentPanel"></chess-manage-student-panel>
        <!-- 师徒管理 -->
