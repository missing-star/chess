<template>
  <div class="chess-home">
    ...
    <div class="cloud-wrapper">
      <img v-for="n in cloudList" :src="require(../assets/images/cloud-1.png)" :key="n" alt="">
      <!-- <img src="../assets/images/cloud-1.png" class="cloud-icon">
      <img src="../assets/images/cloud-2.png" class="cloud-icon">
      <img src="../assets/images/cloud-3.png" class="cloud-icon">
      <img src="../assets/images/cloud-4.png" class="cloud-icon">
      <img src="../assets/images/cloud-5.png" class="cloud-icon">
      <img src="../assets/images/cloud-6.png" class="cloud-icon">
      <img src="../assets/images/cloud-7.png" class="cloud-icon">
      <img src="../assets/images/cloud-8.png" class="cloud-icon">
      <img src="../assets/images/cloud-9.png" class="cloud-icon"> -->
    </div>
    <!-- 背景音乐 -->
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <div class="progress-bar"
                :style="studentInfo.experience/studentInfo.total_experience*100+'%' | filterWidth"></div>
            </div>
