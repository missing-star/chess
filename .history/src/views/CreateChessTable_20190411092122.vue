        ...
        <div class="left-part-wrapper">
            <div class="content-wrapper">
                ...
                <ul class="record-list-wrapper">
                    <li v-for="(item,index) in showRecordList" :key="index" class="record-item" :class="{active:index == showRecordList.length - 1}">
...
import {initChess,onChose,recordList,showRecordList} from '../assets/js/CChess'
