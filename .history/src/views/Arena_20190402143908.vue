    ...
    <div class="chess-arena-wrapper">
        ...
        <div class="category-wrapper">
            <div class="category-item">
                <button class="start-game pointer" @click="goOnlineRace">在线对战</button>
            </div>
            <div class="category-item">
                <button class="start-game pointer" @click="goEndGame">象棋闯关</button>
            </div>
        </div>
        <chess-online-race-panel @hide="hideOnlineRacePanel" :is-show="showOnlineRacePanel"></chess-online-race-panel>
