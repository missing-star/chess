...
import {initChess,onChose} from '../assets/js/online/CChess'
...
export default {
    ...
    methods:{
        getEngineeMove(map) {
            var bestMove = searchEngine.getGoodMove(transformMap(map)).bestMove;
            var eat = map[bestMove.to.y][bestMove.to.x] == 0 ? null : true;
            setTimeout(function () {
