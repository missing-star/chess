    ...
    <div class="right-part-wrapper">
      ...
      <div class="race-operation-wrapper">
        ...
        <div class="operation-group-btn">
          <img @click="reDo" src="../../public/images/重做.png" class="operation-item-btn pointer">
          <img @click="showAnswer" src="../../public/images/答案.png" class="operation-item-btn pointer">
          <img src="../../public/images/上一题.png" class="operation-item-btn pointer">
          <img src="../../public/images/下一题.png" class="operation-item-btn pointer">
        </div>
      </div>
