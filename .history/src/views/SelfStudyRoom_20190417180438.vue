    ...
    <div class="right-part-wrapper">
      ...
      <div class="race-operation-wrapper">
        ...
        <div class="operation-group-btn">
          <img @click="reDo" src="/images/重做.png" class="operation-item-btn pointer">
          <img @click="showAnswer" src="/images/答案.png" class="operation-item-btn pointer">
          <img src="/images/上一题.png" class="operation-item-btn pointer">
          <img src="/images/下一题.png" class="operation-item-btn pointer">
        </div>
      </div>
