            ...
            <div class="race-operation-wrapper">
                ...
                <div class="operation-group-btn">
                    <div class="operation-item pointer">
                        <img @click="fillUp" src="./images/摆满棋子.png" alt="摆满棋子" class="operation-item-icon not-active">
                        <img src="./images/摆满棋子-选中.png" alt="摆满棋子-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="forward" src="./images/前进.png" alt="前进" class="operation-item-icon not-active">
                        <img src="./images/前进-选中.png" alt="前进-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="backOff" src="./images/后退.png" alt="后退" class="operation-item-icon not-active">
                        <img src="./images/后退-选中.png" alt="后退-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="flip" src="./images/翻转.png" alt="翻转" class="operation-item-icon not-active">
                        <img src="./images/翻转-选中.png" alt="翻转-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="reset" src="./images/重置.png" alt="重置" class="operation-item-icon not-active">
                        <img src="./images/重置-选中.png" alt="重置-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="saveChessMap" src="./images/确定.png" alt="确定" class="operation-item-icon not-active">
                        <img src="./images/确定-选中.png" alt="确定-active" class="operation-item-icon active">
                    </div>
                    <div class="operation-item pointer">
                        <img @click="save" src="./images/保存.png" alt="保存" class="operation-item-icon not-active">
...
<style scoped>
    ...
    div.left-part-wrapper,div.right-part-wrapper{
        background: url(./images/信息显示底.png) no-repeat;
    ...
    div.middle-part-wrapper{
        background: url(./images/棋盘底.png) no-repeat;
        background-size: 100% 100%;
        width: 100vh;
        height: 100vh;
        min-height: 900px;
    ...
    div.chess-panel{
        width: 81%;
        height: 90%;
        background: url(./images/棋盘.png) no-repeat;
    ...
    div.user-logo-wrapper{
        background: url(./images/黑方头像底.png) no-repeat;
        background-size: 100% 100%;
        width: 7vh;
        height: 7vh;
        display: flex;
    ...
    div.race-operation-wrapper{
        background: url(./images/操作台底.png) no-repeat;
        background-size: 100% 100%;
        height: 22rem;
    }
    .right-part-wrapper {
    ...
    span.chess-item.active {
        background: url(./images/select-chess.png) no-repeat;
        background-size: 100% 100%;
    }
</style>
