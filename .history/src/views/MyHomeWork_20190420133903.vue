...
import {initChess,onChose,map,recordList,isFinshed, tipsCount, recordList,currentindex} from "../assets/js/my-homework/CChess";
    ...
    getChessDetail(id) {
      this.$axios({
          ...
          if(res.data.status == 1) {
              ...
              JSON.parse(res.data.data.task.chess_manual.data_text)
