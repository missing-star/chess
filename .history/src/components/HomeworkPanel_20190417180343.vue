                ...
                <template v-else>
                  <div class="finish-bonus-content">
                    <p class="content-title">
                      <img src="../../public/images/temp-icon.png" class="bonus-icon">30
                    </p>
                  </div>
...
div.chess-homework-panel-body {
  background: url(../../public/images/homework-bg-1.png) no-repeat,
...
div.chess-homework-panel-body.platform {
  background: url(../../public/images/homework-bg-2.png) no-repeat,
    url(../../public/images/notice-bg-color.png) no-repeat;
  background-size: 100% 100%, 95% 85%;
  background-position: center, center 80%;
}
...
.tabbar-wrapper {
  ...
  left: calc(25% + 365px);
  z-index: 2;
  background: url(../../public/images/homework-tab-2.png) no-repeat;
  background-size: 100% 100%;
  width: 15.5rem;
  height: 7.5rem;
...
.tabbar-wrapper.platform {
  background-image: url(../../public/images/homework-tab-1.png);
  left: calc(25% + 152px);
  top: 15.2%;
}
