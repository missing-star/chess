                        ...
                        <div class="top-layer-wrapper">
                            <div class="login-wrapper">
                                ...
                                <template v-else-if="currentIndex == 1">
                                    ...
                                    <chess-input @trigger="triggerRole" styles="width:36.5%;margin:2% 0;margin-left:1%;"
                                        readonly label="性别" type="text" width="100%" v-model="sex"></chess-input>
                                    <chess-select :option-list="roleList" @select="sexList" :is-show="showSelectSex"
                                        styles="position:absolute;right:15%;top:28%;z-index:1"></chess-select>
                                    <chess-input styles="width:36.5%;margin:2% 0;margin-left:1%;" label="卡号" type="text"
                                        width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:36.5%;margin:2% 0;margin-left:1%;" label="激活码"
                                        type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:36.5%;margin:2% 0;margin-left:1%;" label="家长手机"
                                        type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:36.5%;margin:2% 0;margin-left:1%;" label="等级" type="text"
                                        width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:36.5%;margin:2% 0;margin-left:1%;" label="学校" type="text"
                                        width="50%" v-model="password"></chess-input>
