        ...
        <div class="chess-dialog-body chess-check-homework-body" :class="{'hide':!isShow}">
            ...
            <div class="content-wrapper-container">
                ...
                <ul class="apprentice-wrapper">
                    <li v-for="n in 20" :key="n" class="apprentice-item">
                        ...
                        <img v-if="n % 2 ==0" src="images/check-icon.png" @click="checkHomework(n)" class="check-icon pointer">
            ...
            <div class="bottom-wrapper">
                ...
                <div class="right-part">
                    <img src="images/submit-btn.png" class="submit-btn pointer">
                </div>
            </div>
        </div>
...
<style scoped>
    div.chess-check-homework-body{
        background: url(images/check-homework-border-bg.png) no-repeat,url(images/apprentice-color-bg.png) no-repeat; 
