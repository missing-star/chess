            ...
            <div class="content-wrapper-container">
                ...
                <ul class="apprentice-wrapper">
                    <li v-for="student in studentList" :key="student.id" class="apprentice-item">
                        ...
                        <button @click="toggleStudent(item.id,$event)" class="add pointer not-selected">添加</button>
                        <button @click="toggleStudent(item.id,$event)" class="add pointer selected">已选</button>
                    </li>
                </ul>
            </div>
