    ...
    <div class="chess-dialog-body chess-com-panel-body" :class="{'hide':!isShow}">
      ...
      <div class="content-wrapper-container">
        <div class="category-wrapper">
          <div @click="openPanel(item.id)" v-for="item in categoryList" :key="item.id" class="category-item pointer">
            <img :src="item.icon" class="category-item icon">
          </div>
        </div>
        <div class="userinfo-wrapper">
          <img :src="information.picture | filterImg" class="user-logo">
          ...
          <div class="exp-wrapper">
            ...
            <div class="exp-progressbar-wrapper">
              <div class="exp-progressbar"
                :style="information.experience/information.total_experience*100+'%' | filterWidth"></div>
            </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      playMusic() {
        this.$nextTick(() => {
          this.$refs.comBg.addEventListener('canplay', () => {
            this.$refs.comBg.play();
          });
        });
      },
      stopMusic() {
        this.$refs.comBg.stop();
      }
    },
    filters: {
