<template>
  <div class="water-box">
    <div class="chess-dialog-body1 water-box-wrap" :class="{'hide':!isShow}">
      <img v-if="isOperation" src="../assets/images/close.png" class="mail-box-close" @click="closeMyself">

      <img :src="waterImg" class="water-img" alt>

      <div v-if="isOperation" class="water-box-foot">
...
export default {
  ...
  props: ["is-show","waterImg","againImg","nextImg","is-operation"],
  components: {
...
<style scoped>
.water-box-wrap {
  background: url(../assets/images/弹框-喷水.png) no-repeat;
