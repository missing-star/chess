        ...
        <div class="chess-dialog-body chess-check-homework-body" :class="{'hide':!isShow}">
            ...
            <div class="content-wrapper-container">
                ...
                <ul class="apprentice-wrapper">
                    <li v-for="homework in homeworkList" :key="homework.id" class="apprentice-item">
                        ...
                        <img @click="editHomework" src="../../public/images/edit-homework.png" class="check-icon edit pointer">
                        <img src="../../public/images/checked-homework.png" class="check-icon checked">
                    </li>
                </ul>
            </div>
            <div class="bottom-wrapper">
                ...
                <div class="right-part">
                    <img src="../../public/images/submit-btn.png" @click="assignHomework" class="submit-btn pointer">
                </div>
            </div>
        </div>
...
<style scoped>
    div.chess-check-homework-body{
        background: url(../../public/images/select-homework-bg.png) no-repeat,url(../../public/images/apprentice-color-bg.png) no-repeat; 
