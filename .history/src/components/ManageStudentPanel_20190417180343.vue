        ...
        <div class="category-wrapper">
          <div class="student-info-wrapper">
            <div class="grade-info-wrapper">
              ...
              <div class="grade-name">
                ...
                <img
                  src="../../public/images/add-student.png"
                  @click="addStudent"
                  alt="添加学员"
            ...
            <div class="btn-group">
              <img
                src="../../public/images/check-homework.png"
                alt="批改作业"
                @click="checkHomework"
                class="check-homework-icon pointer"
              >
              <img
                src="../../public/images/assign-homework.png"
                alt="布置作业"
          ...
          <div class="homework-condition-wrapper">
            <div class="next-page swiper-button-prev">
              <img
                v-if="isFirstPage"
                src="../../public/images/arrow-left-disabled-s.png"
                class="navigation-icon"
              >
              <img v-else src="../../public/images/arrow-left-s.png" class="navigation-icon">
            </div>
            <div class="pre-page swiper-button-next">
              <img
                v-if="isLastPage"
                src="../../public/images/arrow-right-disabled-s.png"
                class="navigation-icon"
              >
              <img v-else src="../../public/images/arrow-right-s.png" class="navigation-icon">
            </div>
          ...
          <img
            src="../../public/images/create-now.png"
            @click="createGrade"
            alt="创建班级"
        ...
        <div class="homework-wrapper">
          <div class="top-wrapper">
            ...
            <img
              @click="deleteStudent"
              v-else
              src="../../public/images/delete-active.png"
              class="delete-icon"
            >
          ...
          <ul class="student-list-wrapper">
            <li v-for="student in studentList" :key="student.id" class="student-item">
              ...
              <img src="../../public/images/homework-icon2.png" class="edit-icon">
              ...
              <img src="../../public/images/checked-homework.png" class="checked-icon">
            </li>
          </ul>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      categoryList: [
        { id: 0, icon: require("../../public/images/成长日志.png") },
        { id: 1, icon: require("../../public/images/我的成就.png") },
        { id: 2, icon: require("../../public/images/我的作业.png") },
        { id: 3, icon: require("../../public/images/自习室.png") }
      ],
...
div.chess-student-detail-body {
  background: url(../../public/images/student-management-bg.png) no-repeat;
...
span.level-wrapper {
  color: #c99c77;
  background: url(../../public/images/level-bg.png) no-repeat;
  background-size: 100% 100%;
  width: 3rem;
  height: 1.6rem;
  display: inline-flex;
...
li.student-item {
  ...
  align-items: center;
  justify-content: space-around;
  background: url(../../public/images/homework-list-bg.png) no-repeat;
  background-size: 100% 100%;
  margin: 0.5rem 0;
  padding: 0.5rem 0;
}
...
button.detail-btn {
  background: url(../../public/images/detail-btn-c.png) no-repeat;
  background-size: 100% 100%;
  border: none;
  outline: 0;
  width: 3.5rem;
