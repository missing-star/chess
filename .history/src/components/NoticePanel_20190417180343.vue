    ...
    >
      ...
      <div class="content-wrapper-container">
        <ul class="msg-list-wrapper">
          ...
          >
            <!-- <img src="../../public/images/unread.png" class="unread-icon"> -->
...
div.chess-notice-panel-body {
  background: url(../../public/images/notice-bg-1.png) no-repeat,
...
div.chess-notice-panel-body.platform {
  background: url(../../public/images/notice-bg-2.png) no-repeat,
    url(../../public/images/notice-bg-color.png) no-repeat;
  background-size: 100% 100%, 95% 85%;
  background-position: center, center 80%;
}
...
li.msg-item {
  ...
  background: url(../../public/images/msg-bg.png) no-repeat;
  background-size: 100% 100%;
  padding: 0.8rem 1rem;
}
...
.tabbar-wrapper {
  ...
  left: calc(25% + 365px);
  z-index: 2;
  background: url(../../public/images/notice-tab-1.png) no-repeat;
  background-size: 100% 100%;
  width: 15.5rem;
  height: 7.5rem;
  display: inline-block;
...
.tabbar-wrapper.platform {
  background-image: url(../../public/images/notice-tab-2.png);
  left: calc(25% + 152px);
  top: 15.2%;
}
