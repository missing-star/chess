            ...
            <div class="content-wrapper">
                ...
                <div class="login-and-register-wrapper">
                    <div class="bottom-layer-wrapper">
                        <!-- 登录tab -->
                        <img src="../assets/images/login-btn.png" :class="{active:currentIndex == 0}" class="login-tab login pointer">
                        <!-- 注册tab -->
                        <img src="../assets/images/register-btn.png" :class="{active:currentIndex == 0}" class="login-tab register pointer">
