        ...
        <div class="chess-dialog-body chess-check-homework-body" :class="{'hide':!isShow}">
            ...
            <div class="content-wrapper-container">
                ...
                <ul class="apprentice-wrapper">
                    <li v-for="homework in homeworkList" :key="homework.id" class="apprentice-item">
                        <p @click="toggleHomework(homework.id,$event)" class="homework-name pointer">{{homework.title}}</p>
            ...
            <div class="bottom-wrapper">
                ...
                <div class="middle-part">
                    <p v-for="item in selectedList" :key="item" class="select-homework-item">作业名称</p>
                </div>
...
export default {
    ...
    methods: {
        ...
        toggleHomework(id,e) {
            if(this.selectedList.length == 1 && !this.selectedList.includes(id)) {
                return;
            }
        ...
        assignHomework() {
            ...
            this.$axios({
                ...
                data:this.qs.stringify({
                    question_ids:this.selectedList.join(","),
