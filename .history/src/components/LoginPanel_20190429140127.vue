            ...
            <div class="content-wrapper">
                ...
                <div class="login-and-register-wrapper">
                    <div class="bottom-layer-wrapper">
                        <!-- 登录tab -->
                        <img @click="switchTab(0)" src="../assets/images/login-btn.png" :class="{active:currentIndex == 0}" class="login-tab login pointer">
                        <!-- 注册tab -->
                        <img @click="switchTab(1)" src="../assets/images/register-btn.png" :class="{active:currentIndex == 1}" class="login-tab register pointer">
