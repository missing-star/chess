...
div.chess-mail-box-body {
  background: url(../../public/images/dialog-mailbox-bg.png) no-repeat;
  background-size: 100% 100%;
}
div.content-wrapper-container {
  background: url(../../public/images/yellow-1.png) no-repeat;
  width: 82%;
  height: 72%;
  background-size: 100% 100%;
  margin-top: 14%;
...
p.unread-number {
  ...
  right: 1.5rem;
  top: 1.5rem;
  background: url(../../public/images/unread-all.png) no-repeat;
  background-size: 100% 100%;
  line-height: 1.8rem;
  text-align: center;
  color: #ffffff;
