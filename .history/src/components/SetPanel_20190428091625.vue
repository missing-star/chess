      ...
      <div class="content-wrapper">
        <div class="user-and-time-wrapper">
          <section class="user-wrapper">
            <img src="../assets/images/user-logo.png" class="user-logo pointer">
          ...
          <section class="time-wrapper">
            ...
            <div class="time-control-wrapper">
              <chess-switch
                @trigger="triggerTime"
                :current-time-value="currentTimeValue"
                time-value="30"
                icon="30.png"
                styles="width:48%;"
                active-title="开启30分钟"
                un-active-title="关闭30分钟"
              ></chess-switch>
              <chess-switch
                @trigger="triggerTime"
                :current-time-value="currentTimeValue"
              ...
              <chess-switch
                ...
                icon="120.png"
                styles="width:48%;"
                active-title="开启120分钟"
                un-active-title="关闭120分钟"
              ></chess-switch>
            </div>
          </section>
        </div>
