            ...
            <div class="content-wrapper-container">
                ...
                <ul class="apprentice-wrapper">
                    <li v-for="n in 20" :key="n" class="apprentice-item">
                        ...
                        <img v-if="n % 2 ==0" src="../../public/images/check-icon.png" @click="checkHomework(n)" class="check-icon pointer">
                        <span v-else class="score">89</span>
                    </li>
                </ul>
            </div>
            <div class="bottom-wrapper">
                <div class="left-part">
                    <img src="../../public/images/personal-info-logo-wrapper.png" class="logo-wrapper">
                    <div class="grade-info-wrapper">
                        <p class="grade-title">一期3班</p>
                        <p class="total-homework">
                            作业总计23份
                        </p>
                    </div>
                </div>
                <div class="middle-part">
                    <p class="uncheck-total">
                        未批改12份
                    </p>
                    <p class="checked-total">
                        已批改11份
                    </p>
                </div>
                <div class="right-part">
                    <img src="../../public/images/submit-btn.png" class="submit-btn pointer">
                </div>
            </div>
        </div>
...
<style scoped>
    div.chess-check-homework-body{
        background: url(../../public/images/check-homework-border-bg.png) no-repeat,url(../../public/images/apprentice-color-bg.png) no-repeat; 
    ...
    div.middle-part{
        background: url(../../public/images/middle-bg.png) no-repeat;
        background-size: 100% 100%;
        width: 30%;
        height: 50%;
        margin-top: 1rem;
