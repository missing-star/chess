                ...
                <div class="category-wrapper">
                    <div class="student-info-wrapper">
                        <div class="grade-info-wrapper">
                            ...
                            <div class="grade-name">
                                <p class="grade-editor">
                                    ...
                                    <img src="../assets/images/edit-icon.png" alt="编辑" class="edit-grade-icon pointer" @click="editGradeName">
                                </p>
                        ...
                        <div class="btn-group">
                            ...
                            <img :class-id="currentGrade.id" :class-name="currentGrade.nickname" src="../assets/images/assign-homework.png" alt="布置作业" @click="assignHomework" class="assign-homework-icon pointer">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        editGradeName() {
            ...
            this.$axios({
                method:'post',
                url:`${process.env.VUE_APP_URL}index.php?r=api-teach/edit-class-nickname`,
        ...
        getMyGradeList() {
            ...
            this.$axios({
                ...
                if(this.currentGrade.id == '') {
                    ...
                    this.getStudentsByGradeId(this.currentGrade.id,this.currentGrade.nickname);
                }
                this.initSwiper();
            }).catch(() => {
        ...
        getStudentsByGradeId(id,name,index) {
            ...
            this.$axios({
                method:'post',
                url:`${process.env.VUE_APP_URL}index.php?r=api-teach/select-student-list-by-class-id`,
                data:this.qs.stringify({
                    class_id:id
                })
            }).then((res) => {
