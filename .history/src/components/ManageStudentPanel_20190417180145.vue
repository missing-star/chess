      ...
      <div class="content-wrapper-container">
        <div class="category-wrapper">
          <div class="student-info-wrapper">
            ...
            <div class="btn-group">
              <img
                src="images/check-homework.png"
                alt="批改作业"
                @click="checkHomework"
                class="check-homework-icon pointer"
              >
              <img
                src="images/assign-homework.png"
                alt="布置作业"
          ...
          <div class="homework-condition-wrapper">
            <div class="next-page swiper-button-prev">
              <img
                v-if="isFirstPage"
                src="images/arrow-left-disabled-s.png"
                class="navigation-icon"
              >
              <img v-else src="images/arrow-left-s.png" class="navigation-icon">
            </div>
            <div class="pre-page swiper-button-next">
              <img
                v-if="isLastPage"
                src="images/arrow-right-disabled-s.png"
                class="navigation-icon"
              >
              <img v-else src="images/arrow-right-s.png" class="navigation-icon">
            </div>
        ...
        <div class="homework-wrapper">
          ...
          <ul class="student-list-wrapper">
            <li v-for="student in studentList" :key="student.id" class="student-item">
              ...
              <img src="images/homework-icon2.png" class="edit-icon">
              ...
              <img src="images/checked-homework.png" class="checked-icon">
            </li>
          </ul>
        </div>
      </div>
...
div.chess-student-detail-body {
  background: url(images/student-management-bg.png) no-repeat;
...
button.detail-btn {
  background: url(images/detail-btn-c.png) no-repeat;
  background-size: 100% 100%;
  border: none;
  outline: 0;
  width: 3.5rem;
