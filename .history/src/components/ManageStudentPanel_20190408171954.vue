                ...
                <div class="category-wrapper">
                    ...
                    <div class="homework-condition-wrapper">
                        <div class="next-page swiper-button-prev">
                            <img v-if="!isFirstPage" src="../assets/images/arrow-left-s.png" class="navigation-icon">
                            <img v-else src="../assets/images/arrow-left-disabled-s.png" class="navigation-icon">
                        </div>
                        <div class="pre-page swiper-button-next">
                            <img v-if="!isLastPage" src="../assets/images/arrow-right-s.png" class="navigation-icon">
                            <img v-else src="../assets/images/arrow-right-disabled-s.png" class="navigation-icon">
                        </div>
...
<style scoped>
    ...
    .next-page.swiper-button-prev.swiper-button-disabled {
        width: 1.8rem;
        left: -1.2rem;
        position: absolute;
    }
