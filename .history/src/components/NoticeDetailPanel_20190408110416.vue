        ...
        <div class="chess-dialog-body chess-tips-body" :class="{'hide':!isShow}">
            ...
            <article>
                ...
                <section class="article-content">
                    <span :key="n" v-for="n in 100">公告详情代付款</span>
                </section>
                <p class="info-source">平台信息</p>
            </article>
        </div>
...
<style scoped>
    ...
    div.tips-title{
        background: url(../assets/images/public-notice-title.png) no-repeat;
    ...
    h3.article-title,p.info-source{
        font-weight: bold;
        font-size: 1.2rem;
        margin-bottom: 1rem;
    }
