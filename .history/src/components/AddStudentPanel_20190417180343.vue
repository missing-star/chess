    ...
    <div class="chess-dialog-body chess-check-homework-body" :class="{'hide':!isShow}">
      ...
      <div class="content-wrapper-container">
        ...
        <ul class="apprentice-wrapper">
          <li v-for="student in studentList" :key="student.id" class="apprentice-item">
            ...
            <img src="../../public/images/study-icon.png" class="home-icon">
      ...
      <div class="bottom-wrapper">
        ...
        <div class="right-part">
          <img
            @click="confirmAdd"
            src="../../public/images/confirm-add.png"
  ...
  methods: {
    ...
    confirmAdd() {
      ...
      this.$axios({
        ...
        }index.php?r=api-teach/add-student-class`,
        ...
        .then(res => {
          if (res.data.status == 1) {
            this.avter = require("../../public/images/添加学员.png");
...
div.chess-check-homework-body {
  background: url(../../public/images/add-student-bg.png) no-repeat,
    url(../../public/images/apprentice-color-bg.png) no-repeat;
...
div.bottom-wrapper {
  background: url(../../public/images/bottom-bg.png) no-repeat;
  background-size: 100% 100%;
  position: absolute;
  width: 96%;
  height: 12rem;
...
div.middle-part {
  ...
  height: 40%;
  margin-top: 2rem;
  background: url(../../public/images/select-list-wrapper.png) no-repeat;
  background-size: 100% 100%;
...
p.uncheck-total {
  background: url(../../public/images/btn-bg.png) no-repeat;
  background-size: 100% 100%;
  padding: 0.5rem;
  color: #fff;
  font-size: 0.8rem;
...
button.add {
  background: url(../../public/images/add-bg.png) no-repeat;
  background-size: 100% 100%;
  border: none;
  outline: 0;
  color: #fff;
...
button.add.selected {
  background: url(../../public/images/add-checked-bg.png) no-repeat;
  background-size: 100% 100%;
  border: none;
  outline: 0;
  color: #fff;
