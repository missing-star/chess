            ...
            <div class="content-wrapper-container">
                    ...
                    <div class="student-info-wrapper">
                        ...
                        <div class="exp-wrapper">
                            ...
                            <div class="progressbar-wrapper">
                                <div class="progressbar" :style="{width:(studentInfo.experience / studentInfo.total_experience)*100+'%'}"></div>
                            </div>
                            <p class="exp-number">{{studentInfo.experience}} / {{studentInfo.total_experience}}</p>
                        </div>
                    </div>
                    <div class="homework-condition-wrapper">
                        ...
                        <div class="finished-and-checking">
                            <div class="item finshed">
                                <img src="../../public/images/homework-icon.png" class="check-icon">
                                <p class="content">已完成{{finishedList.length}}卷</p>
                            </div>
                        </div>
                        <div class="not-finished-wrapper">
                            <img src="../../public/images/unfinished-icon.png" class="check-icon">
                ...
                <div class="homework-wrapper">
                    ...
                    <ul class="homework-list-wrapper" v-show="currentIndex == 0">
                        <li v-for="homework in finishedList" :key="homework.id" class="homework-item">
                            <p class="homework-name">{{homework.title}}</p>
                            <span class="dashed-line">····</span>
                            <img src="../../public/images/homework-common-icon.png" class="homework-icon">
                    ...
                    <ul class="homework-list-wrapper" v-show="currentIndex == 1">
                        <li v-for="homework in unFinishList" :key="homework.id" class="homework-item">
                            <p class="homework-name">{{homework.title}}</p>
                            <span class="dashed-line">····</span>
                            <img src="../../public/images/homework-common-icon.png" class="homework-icon">
    ...
    watch:{
        stuId:function() {
            ...
            this.$axios({
                ...
                if(res.data.status == 1) {
                    this.finishedList = res.data.data.filter((homework) => {
...
<style scoped>
    div.chess-student-detail-body{
        background: url(../../public/images/student-detail-panel-bg.png) no-repeat; 
    ...
    .tabbar-item.finished.active{
        background: url(../../public/images/finished-active.png) no-repeat;
        background-size: 100% 100%;
    }
    .tabbar-item.unfinished{
        background: url(../../public/images/unfinished.png) no-repeat;
        background-size: 100% 100%;
    ...
    .tabbar-item.unfinished.active{
        background: url(../../public/images/unfinished-active.png) no-repeat;
        background-size: 100% 100%;
        transform: rotate(-1deg);
        position: relative;
        top: 0.1rem;
