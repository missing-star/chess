<template>
  <ul class="chess-select-wrapper" :style="styles" v-show="isShow">
    ...
    >
      ...
      <img src="../../public/images/not-select.png" class="select-icon not-active">
      <img src="../../public/images/selected.png" class="select-icon active">
    </li>
  </ul>
</template>
<script>
...
ul.chess-select-wrapper {
  background: url(../../public/images/option-bg.png) no-repeat;
