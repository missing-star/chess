            ...
            <div class="content-wrapper-container">
                <div class="user-fight-wrapper">
                    <div class="user-left">
                        ...
                        <img src="/images/user-logo.png" alt="" class="user-logo">
                    </div>
                    <img src="/images/vs.png" alt="vs" class="vs-icon">
                ...
                <div class="img-wrapper">
                    ...
                    <img src="/images/online-race-middle-icon.png" alt="">
                    <img src="/images/elephant.png" alt="">                
                </div>
                <img v-if="waitTime == 0"  @click="startFight" src="/images/start-game.png" alt="开战" class="start-icon pointer">
...
<style scoped>
    div.chess-online-race-body{
        background: url(/images/online-race-bg.png) no-repeat; 
