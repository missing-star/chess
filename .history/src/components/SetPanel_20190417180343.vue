                ...
                <div class="user-and-time-wrapper">
                    <section class="user-wrapper">
                        ...
                        <div class="button-wrapper">
                            <img src="../../public/images/exit-login.png" alt="退出登录" @click="loginOut">
                        </div>
                        <div class="button-wrapper">
                            <img src="../../public/images/change-pwd.png" alt="修改密码">
                        </div>
                    </section>
...
<style scoped>
    div.chess-set-panel-body{       
        background: url(../../public/images/dialog-setting-bg.png) no-repeat;   
    ...
    input[type=range]::-webkit-slider-thumb {
        ...
        position: relative;
        top: -0.825rem;
        background-image: url(../../public/images/speaker.png);
        background-size: 100% 100%;
