                    ...
                    <div class="homework-condition-wrapper">
                        ...
                        <div class="finished-and-checking">
                            <div class="item finshed">
                                <img src="images/homework-icon.png" class="check-icon">
                                <p class="content">已完成{{finishedList.length}}卷</p>
                            </div>
                        </div>
                        <div class="not-finished-wrapper">
                            <img src="images/unfinished-icon.png" class="check-icon">
                ...
                <div class="homework-wrapper">
                    ...
                    <ul class="homework-list-wrapper" v-show="currentIndex == 0">
                        <li v-for="homework in finishedList" :key="homework.id" class="homework-item">
                            ...
                            <img src="images/homework-common-icon.png" class="homework-icon">
...
<style scoped>
    div.chess-student-detail-body{
        background: url(images/student-detail-panel-bg.png) no-repeat; 
    ...
    li.homework-item {
        ...
        background: url(images/homework-list-bg.png) no-repeat;
        background-size: 100% 100%;
    }
    .tabbar-wrapper {
        position: absolute;
    ...
    .tabbar-item.finished.active{
        background: url(images/finished-active.png) no-repeat;
        background-size: 100% 100%;
    }
    ...
    .tabbar-item.unfinished.active{
        background: url(images/unfinished-active.png) no-repeat;
        background-size: 100% 100%;
        transform: rotate(-1deg);
        position: relative;
        top: 0.1rem;
