                        ...
                        <div class="top-layer-wrapper">
                            <div class="login-wrapper">
                                ...
                                <template v-else-if="currentIndex == 1">
                                    ...
                                    <chess-input select styles="width:36.5%;margin:2% 0;margin-left:1%;" label="等级"
                                        type="text" width="50%" v-model="level"></chess-input>
                                    <chess-input select styles="width:36.5%;margin:2% 0;margin-left:1%;" label="学校"
                                ...
                                <template v-else-if="currentIndex == 2">
                                    <chess-input label="卡号" type="text"
                                        width="50%" v-model="cardNumber"></chess-input>
                                    <chess-input label="激活码"
                                        type="text" width="50%" v-model="activeCode"></chess-input>
                                    <chess-input label="姓名"
                                        type="text" width="50%" v-model="phone"></chess-input>
                                    <chess-input select label="密码"
                                        type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input select label="确认密码"
                                        type="text" width="50%" v-model="repassword"></chess-input>
                                    <div class="operation-group">
                                        <button @click="register" :disabled="!isCanRegister"
                                            :class="{active:isCanRegister}" class="register pointer"></button>
                                    </div>
