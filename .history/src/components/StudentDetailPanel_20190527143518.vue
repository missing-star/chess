      ...
      <div class="content-wrapper-container">
        <div class="category-wrapper">
          ...
          <div class="relive-mentor-relationship">
            <p class="button-relive pointer" @click="reliveRelationship">解除师生关系</p>
          </div>
        </div>
        <div class="homework-wrapper">
          <div class="tabbar-wrapper">
            <div
              @click="switchIndex(0)"
              class="tabbar-item pointer finished"
              :class="{active:currentIndex == 0}"
            ></div>
            <div
              @click="switchIndex(1)"
              class="tabbar-item pointer unfinished"
          ...
          <ul class="homework-list-wrapper" v-show="currentIndex == 1">
            <li v-for="homework in unFinishList" :key="homework.id" class="homework-item">
              ...
              <span class="dashed-line">····</span>
              <img src="../assets/images/homework-common-icon.png" class="homework-icon">
              <p class="homework-time auto">{{homework.create_at}}</p>
            </li>
          </ul>
        </div>
      </div>
