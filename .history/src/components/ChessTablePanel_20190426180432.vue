      ...
      <div class="content-wrapper-container">
        <div class="create-delete-wrapper">
          <img
            ...
            src="../assets/images/create-table-btn.png"
            alt="创建棋谱"
        ...
        <ul class="task-list-wrapper">
          <li v-for="chess in chessTableList" :key="chess.id" class="task-item">
            ...
            <div @click="getChessTableDetail(chess.id)" class="finish-status-wrapper">查看</div>
...
export default {
  ...
  methods: {
    ...
    getChessTableDetail(id) {
      this.$router.push(`chess-table-detail/${id}`);
    },
    deteleChessTable() {
      //删除棋谱
