<template>
    <div class="chess-notice-panel chess-dialog-wrapper" :class="{'hide':!isShow}">
        ...
        <div class="chess-dialog-body chess-notice-panel-body" :class="{'hide':!isShow,platform:currentIndex == 1}">
            ...
            <div class="content-wrapper-container">
                <ul class="msg-list-wrapper">
                    <li v-for="n in 40" :key="n" class="msg-item">
                        ...
                        <a @click="showNoticeDetail" href="javascript:;" class="detail">详情</a>
                    </li>
                </ul>
            </div>
        </div>
