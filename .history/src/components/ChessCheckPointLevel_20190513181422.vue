        ...
        <div class="swiper-container swiper-1 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-1">
            <ul class="low task-list-wrapper swiper-slide" v-for="n in Math.ceil(1/ 3)" :key="n">
              <li class="task-item" @click="selectLevel(1,0,'初级一',1,100)"></li>
              <li class="task-item" @click="selectLevel(1,1,'初级二',101,200)"></li>
              <li class="task-item" @click="selectLevel(1,2,'初级三',201,300)"></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-container swiper-2 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-2">
            <ul class="normal task-list-wrapper swiper-slide" v-for="n in Math.ceil(1/ 3)" :key="n">
              <li class="task-item" @click="selectLevel(2,0,'中级一',1,100)"></li>
              <li class="task-item" @click="selectLevel(2,1,'中级二',101,200)"></li>
              <li class="task-item" @click="selectLevel(2,2,'中级三',201,300)"></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-container swiper-3 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-3">
            <ul class="high task-list-wrapper swiper-slide" v-for="n in Math.ceil(1 / 3)" :key="n">
              <li class="task-item" @click="selectLevel(3,0,'高级一',1,100)"></li>
              <li class="task-item" @click="selectLevel(3,1,'高级二',101,200)"></li>
              <li class="task-item" @click="selectLevel(3,2,'高级三',201,300)"></li>
            </ul>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    selectLevel(level,stage,title,start,end) {
        //二级页面
      this.closeMyself();
      this.$emit("open-check-point-panel", level, stage,title,start,end);
    }
  },
  mounted() {
