          ...
          <ul class="item-list-wrapper">
            <li class="item" v-for="(item,index) in title" :key="index">
              ...
              <div @click="goPartice(item.id)" class="right-part pointer">
                <img src="../../public/images/arrow-right-task.png" class="arrow-right-icon">
...
div.chess-student-detail-body {
  background: url(../../public/images/self-study-stage-bg.png) no-repeat;
...
p.title {
  background: url(../../public/images/not-active-bg.png) no-repeat;
  background-size: 100% 100%;
  width: 80%;
  height: 3.5rem;
  display: inline-flex;
...
p.title.active {
  background: url(../../public/images/active-bg.png) no-repeat;
  background-size: 100% 100%;
  width: 80%;
  height: 3.5rem;
  display: inline-flex;
...
p.split-line {
  background: url(../../public/images/split-line.png) no-repeat;
  background-size: 100% 100%;
  height: 4px;
  width: 80%;
  margin: 1.3rem auto;
...
p.progressbar {
  width: 80%;
  height: 0.8rem;
  background: url(../../public/images/not-finish-pro.png) no-repeat;
  background-size: 100% 100%;
}
p.progressbar.active {
  width: 80%;
  height: 0.8rem;
  background: url(../../public/images/finish-pro.png) no-repeat;
  background-size: 100% 100%;
}
span.finish-status {
  color: #ff6f00;
