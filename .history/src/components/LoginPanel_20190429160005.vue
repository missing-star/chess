                            ...
                            <div class="login-wrapper">
                                ...
                                <template v-else-if="currentIndex == 1">
                                    ...
                                    <chess-select :option-list="levelList" @select="selectSex" :is-show="showSelectLevel"
                                        styles="position:absolute;right:15%;top:28%;z-index:1;height:50%;ovflow-y:scroll;"></chess-select>
                                    ...
                                    <chess-select :option-list="schoolList" @select="selectSex" :is-show="showSelectSchool"
                                        styles="position:absolute;right:50%;top:52%;z-index:1;height:50%;ovflow-y:scroll;"></chess-select>
