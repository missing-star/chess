                        ...
                        <div class="top-layer-wrapper">
                            <div class="login-wrapper">
                                ...
                                <template v-else-if="currentIndex == 1">
                                    <chess-input label="姓名" type="text" styles="width:35%;margin:2% 0;margin-right:5%;" v-model="username"></chess-input>
                                    <chess-input @trigger="triggerRole" styles="width:35%;margin:2% 0;margin-right:5%;" readonly label="性别" type="text" width="100%"
                                        v-model="role"></chess-input>
                                    <chess-select :option-list="roleList" @select="selectRole" :is-show="showSelectRole"
                                        styles="position:absolute;right:15%;top:28%;z-index:1"></chess-select>
                                    <chess-input styles="width:35%;margin:2% 0;margin-right:5%;" label="卡号" type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:35%;margin:2% 0;margin-right:5%;" label="激活码" type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:35%;margin:2% 0;margin-right:5%;" label="家长手机号" type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:35%;margin:2% 0;margin-right:5%;" label="等级" type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:35%;margin:2% 0;margin-right:5%;" label="学校" type="text" width="50%" v-model="password"></chess-input>
                                    <chess-input styles="width:35%;margin:2% 0;margin-right:5%;" label="密码" type="password" width="50%" v-model="password"></chess-input>
                                    <div class="operation-group">
                                        <div class="password-operation">
                                            <div @click="toggleRemeber" class="remember-me pointer">
                                                <span class="checkbox-icon" :class="{active:rememberMe}"></span>
