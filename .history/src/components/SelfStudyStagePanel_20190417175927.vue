          ...
          <ul class="item-list-wrapper">
            <li class="item" v-for="(item,index) in title" :key="index">
              ...
              <div @click="goPartice(item.id)" class="right-part pointer">
                <img src="./images/arrow-right-task.png" class="arrow-right-icon">
...
div.chess-student-detail-body {
  background: url(./images/self-study-stage-bg.png) no-repeat;
...
p.title {
  background: url(./images/not-active-bg.png) no-repeat;
  background-size: 100% 100%;
  width: 80%;
  height: 3.5rem;
  display: inline-flex;
...
p.progressbar {
  width: 80%;
  height: 0.8rem;
  background: url(./images/not-finish-pro.png) no-repeat;
  background-size: 100% 100%;
}
p.progressbar.active {
  width: 80%;
  height: 0.8rem;
  background: url(./images/finish-pro.png) no-repeat;
  background-size: 100% 100%;
}
span.finish-status {
  color: #ff6f00;
