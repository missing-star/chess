                        ...
                        <div class="top-layer-wrapper">
                            <div class="login-wrapper">
                                ...
                                <template v-if="currentIndex == 0">
                                    <chess-input select @trigger="triggerRole" readonly label="选择身份" type="text" width="100%"
                                ...
                                <template v-else-if="currentIndex == 1">
                                    ...
                                    <chess-input select @trigger="triggerSex" styles="width:36.5%;margin:2% 0;margin-left:1%;"
                                        readonly label="性别" type="text" width="100%" v-model="sex"></chess-input>
                                    ...
                                    <chess-input select styles="width:36.5%;margin:2% 0;margin-left:1%;" label="等级" type="text"
                                        width="50%" v-model="level"></chess-input>
                                    <chess-input select styles="width:36.5%;margin:2% 0;margin-left:1%;" label="学校" type="text"
                                        width="50%" v-model="school"></chess-input>
