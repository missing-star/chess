                    ...
                    <div class="student-info-wrapper">
                        <div class="grade-info-wrapper">
                            ...
                            <div class="grade-name">
                                ...
                                <img src="../assets/images/add-student.png" alt="添加学员" class="add-student-icon">
                            </div>
                        </div>
                        <p class="solid-line"></p>
                        <div class="btn-group">
                            <img src="../assets/images/check-homework.png" alt="批改作业" class="check-homework-icon">
                            <img src="../assets/images/assign-homework.png" alt="布置作业" class="assign-homework-icon">
                        </div>
                    </div>
