            ...
            <div class="content-wrapper-container">
                <div class="content left">
                    ...
                    <div class="result-all-wrapper">
                        <div v-for="n in 4" :key="n" class="result-item">
                            <label class="title">经验值</label>
                            <p class="show-number">20</p>
                        </div>
                    </div>
                </div>
                <div class="content right">
                    ...
                    <ul class="race-list-wrapper">
                        <li v-for="n in 10" :key="n" class="race-item">
                            <p class="race-time">2012-12-22</p>
                            <p class="black-name">哈哈哈</p>
                            <p class="race-result">
