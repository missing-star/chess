        ...
        <div class="swiper-container swiper-1 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-1">
            <ul class="task-list-wrapper swiper-slide" v-for="n in Math.ceil(1/ 3)" :key="n">
              <li class="task-item" @click="selectLevel(1,0)">第一阶段</li>
              <li class="task-item" @click="selectLevel(1,1)">第二阶段</li>
              <li class="task-item" @click="selectLevel(1,2)">第三阶段</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="content-wrapper-container" :class="{active:currentIndex == 1}">
        <div class="swiper-container swiper-2 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-2">
            <ul class="task-list-wrapper swiper-slide" v-for="n in Math.ceil(1/ 3)" :key="n">
              <li class="task-item" @click="selectLevel(2,0)">第一阶段</li>
              <li class="task-item" @click="selectLevel(2,1)">第二阶段</li>
              <li class="task-item" @click="selectLevel(2,2)">第三阶段</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="content-wrapper-container" :class="{active:currentIndex == 2}">
        <div class="swiper-container swiper-3 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-3">
            <ul class="task-list-wrapper swiper-slide" v-for="n in Math.ceil(1 / 3)" :key="n">
              <li class="task-item" @click="selectLevel(3,0)">第一阶段</li>
              <li class="task-item" @click="selectLevel(3,1)">第二阶段</li>
              <li class="task-item" @click="selectLevel(3,2)">第三阶段</li>
            </ul>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    selectLevel(level,stage) {
        //二级页面
      this.closeMyself();
      this.$emit("open-check-point-panel", level, stage);
    }
  },
  mounted() {
