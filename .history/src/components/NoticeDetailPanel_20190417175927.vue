  ...
  <div class="chess-tips-panel">
    <div class="chess-dialog-body chess-tips-body" :class="{'hide':!isShow}">
      ...
      <article>
        ...
        <p class="info-source">{{noticeDetail.type==0?"平台公告":"学校公告"}}</p>
      </article>
    </div>
...
export default {
  name: "chess-notice-detail-panel",
  data() {
    return {};
  },
  methods: {
...
<style scoped>
div.chess-tips-body {
  background: url(./images/tips-bg2.png) no-repeat;
  background-size: 100% 90%;
  background-position: bottom;
}
div.tips-title {
  background: url(./images/public-notice-title.png) no-repeat;
