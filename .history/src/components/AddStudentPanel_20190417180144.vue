      ...
      <div class="content-wrapper-container">
        ...
        <ul class="apprentice-wrapper">
          <li v-for="student in studentList" :key="student.id" class="apprentice-item">
            ...
            <img src="images/study-icon.png" class="home-icon">
      ...
      this.$axios({
        ...
        .then(res => {
          if (res.data.status == 1) {
            this.avter = require("images/添加学员.png");
...
div.chess-check-homework-body {
  background: url(images/add-student-bg.png) no-repeat,
...
div.middle-part {
  ...
  height: 40%;
  margin-top: 2rem;
  background: url(images/select-list-wrapper.png) no-repeat;
  background-size: 100% 100%;
...
button.add.selected {
  background: url(images/add-checked-bg.png) no-repeat;
  background-size: 100% 100%;
  border: none;
  outline: 0;
  color: #fff;
