      ...
      <div class="content-wrapper-container" :class="{active:currentIndex == 0}">
        ...
        <div class="swiper-container swiper-1 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-1">
            <ul class="task-list-wrapper swiper-slide low" v-for="n in Math.ceil(1/ 3)" :key="n">
              <li
                v-for="(item,index) in gameList1.list.child"
                :key="index"
                class="task-item"
                @click="showSelfStudyStagePanel(gameList1.id,index,item.name)"
              ></li>
            </ul>
          </div>
      ...
      <div class="content-wrapper-container" :class="{active:currentIndex == 1}">
        ...
        <div class="swiper-container swiper-2 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-2">
            <ul class="task-list-wrapper swiper-slide normal" v-for="n in Math.ceil(1/ 3)" :key="n">
              <li
                v-for="(item,key) in gameList2.list.child"
                :key="item.id"
                class="task-item"
                @click="showSelfStudyStagePanel(gameList2.id,key,item.name)"
              ></li>
            </ul>
          </div>
      ...
      <div class="content-wrapper-container" :class="{active:currentIndex == 2}">
        ...
        <div class="swiper-container swiper-3 swiper-no-swiping">
          <div class="swiper-wrapper wrapper-3">
            <ul class="task-list-wrapper swiper-slide high" v-for="n in Math.ceil(1 / 3)" :key="n">
              <li
                v-for="(item,key) in gameList3.list.child"
                :key="item.id"
                class="task-item"
                @click="showSelfStudyStagePanel(gameList3.id,key,item.name)"
              ></li>
            </ul>
          </div>
...
export default {
  ...
  methods: {
    closeMyself() {
      this.$emit("hide",this.isOpenParent);
    },
    showSelfStudyStagePanel(id, index,title) {
      //二级页面
      this.closeMyself();
      this.$emit("open-study-stage-panel", id, index,title);
    },
    switchTab(index) {
...
ul.low li {
  background: url(../assets/images/stage-bg.png) no-repeat,url(../assets/images/kill-1.png) no-repeat;
  background-size: 100% 100%,95% 95%;
  background-position: center,center;
}
ul.normal li:nth-child(1) {
  background: url(../assets/images/stage-bg.png) no-repeat,url(../assets/images/kill-2.png) no-repeat;
  background-size: 100% 100%,95% 95%;
  background-position: center,center;
}
ul.normal li:nth-child(2) {
  background: url(../assets/images/stage-bg.png) no-repeat,url(../assets/images/kill-3.png) no-repeat;
  background-size: 100% 100%,95% 95%;
  background-position: center,center;
}
ul.high li:nth-child(1) {
  background: url(../assets/images/stage-bg.png) no-repeat,url(../assets/images/kill-4.png) no-repeat;
  background-size: 100% 100%,95% 95%;
  background-position: center,center;
}
ul.high li:nth-child(2) {
  background: url(../assets/images/stage-bg.png) no-repeat,url(../assets/images/kill-5.png) no-repeat;
  background-size: 100% 100%,95% 95%;
  background-position: center,center;
}
ul.high li:nth-child(3) {
  background: url(../assets/images/stage-bg.png) no-repeat,url(../assets/images/kill-6.png) no-repeat;
  background-size: 100% 100%,95% 95%;
  background-position: center,center;
}
