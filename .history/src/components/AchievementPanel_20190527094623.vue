        ...
        <div class="content right">
          ...
          <div class="score-wrapper">
            <p class="number-wrapper">
              <img :src="integrals[0] | filterScroe" class="number-icon">
            </p>
            <p class="number-wrapper">
              <img :src="integrals[1] | filterScroe" class="number-icon">
            </p>
            <p class="number-wrapper">
              <img :src="integrals[2] | filterScroe" class="number-icon">
            </p>
            <span class="unit">分</span>
          </div>

          <h3 class="recent-weekly-score">近一周积分</h3>
          <ul class="score-wrapper day">
      ...
      option() {
        ...
        const option = {
          ...
          radar: {
            ...
            indicator: [{
                name: "",
                max: this.dayLogin + this.game + this.dayDoneTask
              },
              {
                name: "",
                max: this.dayLogin + this.game + this.dayDoneTask
    ...
    created() {
      this.$axios({
        ...
        .then(res => {
          ...
          var temp = res.data.data.integrals;
          switch (res.data.data.integrals.length) {
            case 1:
...
<style scoped>
  ...
  ul.score-wrapper.day::-webkit-scrollbar {
    height: 0;
    width: 0;
  }
</style>