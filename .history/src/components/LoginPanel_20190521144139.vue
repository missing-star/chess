<template>
    <div @keydown.enter="goLogin" class="chess-set-panel">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            judgeIsCanRegister() {
                if (this.username.toString().trim() != '' && this.password.toString().trim() != '' && this.sex != '' && this.cardNumber
                    .toString().trim() != '' && this.activeCode.toString().trim() != '' && this.phone.toString().trim() != '' && this.level.toString().trim() !=
                    '' &&
                    this.shcool != '') {
                ...
                this.$axios({
                    ...
                    .then(res => {
                        if (res.data.status == 1) {
                            if(this.rememberMe) {
                                localStorage.setItem('loginInfo',JSON.stringify({username:this.username,password:this.password}));
                            }
                            else {
