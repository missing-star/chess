        ...
        <div class="chess-dialog-body chess-online-race-body" :class="{'hide':!isShow}">
            ...
            <div class="content-wrapper-container">
                ...
                <div class="btn-group-wrapper">
                    <button :disabled="waitTime < 15" v-if="isMatchSuccess" @click="startGame" class="online-match-btn pointer success"></button>
                    <button v-else @click="startFight" class="online-match-btn pointer"></button>
                </div>
            </div>
        </div>
...
export default {
    ...
    props:['is-show','wait-time','is-match-success'],
    components:{
