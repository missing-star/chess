        ...
        <div class="chess-dialog-body chess-check-homework-body" :class="{'hide':!isShow}">
            ...
            <div class="content-wrapper-container">
                ...
                <ul class="apprentice-wrapper">
                    <li v-for="n in 20" :key="n" class="apprentice-item">
                        <p @click="toggleStudent(n,$event)" class="username">张某同学</p>
                        ...
                        <img src="../assets/images/study-icon.png" class="home-icon chose">
                        <img src="../assets/images/add-checked-bg.png" class="home-icon chosed">
                        <p class="join-time">09.02.15 入校</p>
                        <button class="add pointer">添加</button>
                    </li>
                </ul>
            </div>
            <div class="bottom-wrapper">
                ...
                <div class="right-part">
                    <img src="../assets/images/confirm-add.png" class="submit-btn pointer">
                </div>
            </div>
        </div>
...
<style scoped>
    ...
    .apprentice-item img.home-icon.chose{
        display: block;
    }
    .apprentice-item.active img.home-icon.chosed{
        display: none;
    }
    .apprentice-item.active img.home-icon.chosed{
        display: block;
