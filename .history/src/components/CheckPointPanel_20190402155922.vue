            ...
            <div class="swiper-container swiper-no-swiping">
                <div class="content-wrapper-container swiper-wrapper">
                    <div class="swiper-slide" v-for="n in Math.ceil(teacherList.length / 12)" :key="n">
                        <div class="teacher-item" v-for="(item,index) in teacherList.slice(12*(n-1),12*(n-1)+12)" :key="item">
                            <img src="../assets/images/zhan.png" class="teacher-logo">
                            <img v-if="index != teacherList.slice(12*(n-1),12*(n-1)+12).length - 1" src="../assets/images/arrow-right-guan.png" class="arrow-guan" :class="{left:index >= 6}">
                        </div>
                    </div>
                </div>
