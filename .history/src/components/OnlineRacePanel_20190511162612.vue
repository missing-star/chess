                ...
                <div class="fighter-wrapper">
                    ...
                    <div class="vs-wrapper">
                        <div class="match-status-wrapper">
                            <img v-if="waitTime == 0 && isMatchSuccess" src="../assets/images/匹配成功.png"
                                class="match-success">
                    ...
                    <div class="user-item">
                        ...
                        <p class="user-level">{{fightLevel}}</p>
                    </div>
                </div>
                <div class="dashed-line"></div>
                <div class="btn-group-wrapper">
                    <button disabled v-if="waitTime != 0 && waitTime <= 15" class="online-match-btn pointer success"></button>
                    <button v-if="waitTime == 0 && !isMatchSuccess" @click="startFight"
                        class="online-match-btn pointer"></button>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        props: ['is-show', 'wait-time', 'is-match-success', 'fight-name', 'fight-logo', 'fight-level'],
        components: {
