            ...
            <div class="content-wrapper-container">
                ...
                <div class="homework-wrapper">
                    <div class="tabbar-wrapper">
                        <div class="tabbar-item pointer finished" :class="{active:currentIndex == 0}">
                            
                        </div>
                        <div class="tabbar-item pointer unfinished" :class="{active:currentIndex == 1}">
                            
                        </div>                            
                    </div>
                    <ul class="homework-list-wrapper">
