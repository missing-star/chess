      ...
      <div class="content-wrapper-container">
        ...
        <div class="content right">
          ...
          <div class="head-category-wrapper">
            <div class="head-item">
              <img src="/images/时间.png" class="head-item-icon">
            </div>
            <div class="head-item">
              <img src="/images/黑方名称.png" class="head-item-icon">
            </div>
            <div class="head-item">
              <img src="/images/战况.png" class="head-item-icon">
            </div>
          </div>
          <ul class="race-list-wrapper">
            <li v-for="(item,index) in growthLog.list" :key="index" class="race-item">
              ...
              <p class="race-result">
                <img
                  :src="item.game==1? require('/images/胜.png'):require('/images/败.png')"
                  class="race-result-icon"
                >
                <span class="race-title">{{item.game==1?"赢":'item.game==2'?"平":"输"}}</span>
                <img src="/images/右键头.png" class="race-result-detail-icon">
              </p>
            </li>
          </ul>
        </div>
...
div.race-result {
  background: url(/images/战况底.png) no-repeat;
  background-size: 100% 100%;
  width: 50%;
  height: 2rem;
  display: inline-flex;
...
div.break-line {
  background: url(/images/分割线.png) no-repeat;
  background-size: 100% 100%;
  height: 0.2rem;
  width: 90%;
}
...
li.race-item {
  background: url(/images/战绩底.png) no-repeat;
  background-size: 100% 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
