import { isFinshed } from "../check-point/CChess";
...
function LoadGround() { //生成旗子
	...
	for (var j = 0; j < 10; j++) {
		for (var i = 0; i < 9; i++) {
			g += "<article class='CS' id='CS" + j + "-" + i + "' onclick='onChoseSelf(" + j + "," + i + ",true)'></article>";
		}
	}
