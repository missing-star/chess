                ...
                <div class="register-login-wrapper">
                    <div class="register-register-wrapper">
                        ...
                        <div class="content" v-if="currentPanel == 1">
                            <chess-input @trigger="triggerRole" readonly styles="width:95%" label="选择身份" type="text" width="100%"></chess-input>
                        ...
                        <div class="content find-pwd" v-if="currentPanel == 2">
                            <chess-input styles="width:95%;margin:0.2rem 0.4rem;" label="卡号" type="text" width="16rem"></chess-input>
                            <chess-input styles="width:95%;margin:0.2rem 0.4rem;" label="激活码" type="text" width="16rem"></chess-input>
                            <chess-input styles="width:95%;margin:0.2rem 0.4rem;" label="姓名" type="text" width="16rem"></chess-input>
