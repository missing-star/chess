  ...
  <div class="chess-online-race-wrapper">
    ...
    <div class="right-part-wrapper">
      <div class="race-operation-wrapper">
        <p class="title operation">老师留言</p>
      ...
      <div class="race-operation-wrapper">
        ...
        <div class="operation-group-btn">
          <div class="operation-item pointer">
            <img
              @click="fillUp"
              src="../assets/images/摆满棋子.png"
              alt="摆满棋子"
              class="operation-item-icon not-active"
            >
            <img
              src="../assets/images/摆满棋子-选中.png"
              alt="摆满棋子-active"
              class="operation-item-icon active"
            >
          </div>
          <div class="operation-item pointer">
            <img
          ...
          <div class="operation-item pointer">
            <img
              @click="flip"
              src="../assets/images/翻转.png"
              alt="翻转"
              class="operation-item-icon not-active"
            >
            <img
              src="../assets/images/翻转-选中.png"
              alt="翻转-active"
              class="operation-item-icon active"
            >
          </div>
          <div class="operation-item pointer">
            <img
              @click="reset"
              src="../assets/images/重置.png"
              alt="重置"
              class="operation-item-icon not-active"
            >
            <img
              src="../assets/images/重置-选中.png"
              alt="重置-active"
              class="operation-item-icon active"
            >
          </div>
          <div class="operation-item pointer">
            <img
              @click="saveChessMap"
              src="../assets/images/确定.png"
              alt="确定"
              class="operation-item-icon not-active"
            >
            <img
              src="../assets/images/确定-选中.png"
              alt="确定-active"
              class="operation-item-icon active"
            >
          </div>
    ...
    <!-- 保存棋谱 -->
    <chess-create-tips-panel
      @save-chess-table="saveChessTable"
      @hide="hideCreateTipsPanel"
      :is-show="showCreateTipsPanel"
    ></chess-create-tips-panel>
  ...
  methods: {
    ...
    saveChessTable(type, title) {
      ...
      this.$axios({
        ...
        }index.php?r=api-teach-chess-manual/create-chess-manual`,
        method: "post",
        ...
        .then(res => {
          ...
          if (res.data.status == 1) {
            this.avter = require("../assets/images/棋谱创建成功.png");
